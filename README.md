...
the files in this repo *are* the live config: editing one edits the other,
...
```bash
git clone git@github.com:<your-username>/dotfiles.git ~/Projects/dotrepo
cd ~/Projects/dotrepo
...
Both scripts are safe to re-run: already-installed tools and
